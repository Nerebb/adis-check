...
exports.catchError = exports.EKeyHeader = void 0;
...
var EKeyHeader;
(function (EKeyHeader) {
    EKeyHeader["REFRESH_TOKEN"] = "x-rtoken-id";
    EKeyHeader["ACCESS_TOKEN"] = "x-atoken-id";
})(EKeyHeader || (exports.EKeyHeader = EKeyHeader = {}));
const catchError = (fun) => (req, res, next) => Promise.resolve(fun(req, res, next)).catch(next);
